...
func ValidateToken(signedtToken string) (claims *SignedDetails, msg string) {
	token,err := jwt.ParseWithClaims(signedtToken,&SignedDetails{},func(token *jwt.Token) (interface{}, error) {
